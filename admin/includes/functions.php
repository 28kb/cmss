...
<?php
    ...
    function post_database() {  //Display Posts Database
        global $connection;
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td><a href='../post.php?p_id=$post_id&page=1'>View Post</a></td>";
            echo "<td><a href='posts.php?source=edit_post&p_id=$post_id'>Edit</a></td>";
            echo "<td><a data-toggle='modal' data-target='#myModal' class='delete_link' rel='$post_id' href='javascript:void(0)'>Delete</a></td>";
            echo "</tr>";
        }
    }
